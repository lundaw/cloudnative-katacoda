...
_Note: If you do not want to die because you cannot get out of vim, change the default editor to `nano` for kubectl with `export KUBE_EDITOR=nano`{{execute}}._
