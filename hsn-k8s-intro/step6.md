...
Now you are going to extend the previous Kopf configuration by adding handlers for `('zalando.org', 'v1', 'kopfexamples')` and printing the `spec` field. In order to do that, you need to extend the `kopf_examples.py`{{open}} file.
